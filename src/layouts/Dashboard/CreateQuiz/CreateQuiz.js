...
const QuizCreate = (props) => {
  ...
  const removeNote = (note) => {
    setSelectedSubquizNotes(
      selectedSubquizNotes.filter((selectedNote) => {
    ...
    <div className={classes.CreateQuiz}>
      ...
      <div className={classes.FlexLayout}>
        <form>
          ...
          <p>
            Create sets of notes by playing on the piano below. After each set,
            press "Next Set". When you're done, press "Submit"!
          </p>
          <div className={classes.Buttons}>
            <input
              ...
              onClick={(event) => submitSet(event, selectedSubquizNotes)}
            />
            <input
              type='submit'
              value='Submit'
              className={classes.SubmitQuiz}
              onClick={(event) => submitQuiz(event, inputData)}
            />
          </div>
        </form>
